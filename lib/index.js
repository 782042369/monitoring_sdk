(function (global, factory) {
	...
	(function (ErrorCategoryEnum) {
	  ...
	  ErrorCategoryEnum["CONSOLE_INFO"] = "console_info";
	  ErrorCategoryEnum["CONSOLE_WARN"] = "console_warn";
	  ErrorCategoryEnum["CONSOLE_ERROR"] = "console_error";
	...
	var BaseMonitor = /*#__PURE__*/function () {
	  ...
	  _createClass(BaseMonitor, [{
	    ...
	    value: function handleErrorInfo() {
	      ...
	      var recordInfo = _objectSpread$1(_objectSpread$1({}, extendsInfo), {}, {
	    ...
	    value: function getExtendsInfo() {
	      try {
	        ...
	        if (isObject(dynamicParams)) {
	          extendsInfo = _objectSpread$1(_objectSpread$1({}, extendsInfo), dynamicParams);
	        } // 遍历扩展信息，排除动态方法
