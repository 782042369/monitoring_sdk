(function (global, factory) {
	  ...
	  var LogicLibrary = function () {
	    return {
	      DeviceInfoObj: function DeviceInfoObj(params) {
	        ...
	        var info = {
	          type: MethodLibrary.getDeviceType(),
	          os: MethodLibrary.getOS(),
	          osv: MethodLibrary.getOSVersion(),
	          h: window.screen.height,
	          w: window.screen.width,
	          lan: MethodLibrary.getLanguage(),
	          net: MethodLibrary.getNetwork(),
	          orientation: MethodLibrary.getOrientationStatu(),
	          browser: MethodLibrary.getBrowserInfo(),
	...
	function firstIn() {
	  var flag = sessionStorage.getItem('ps_first');
	...
	var API = /*#__PURE__*/function () {
	  ...
	  _createClass(API, [{
	    ...
	    value: function report(data) {
	      ...
	      this.reportByImg(_objectSpread$3(_objectSpread$3({}, data), {}, {
	        first: firstIn()
	      }));
	    }
	    /**
