(function (global, factory) {
  ...
  (function (AjaxLibEnum) {
    AjaxLibEnum["AXIOS"] = "axios";
    AjaxLibEnum["DEFAULT"] = "default";
  ...
  var Breadcrumb = /*#__PURE__*/function () {
    function Breadcrumb() {
      ...
      _defineProperty(this, "maxBreadcrumbs", 10);

      _defineProperty(this, "beforePushBreadcrumb", null);
    ...
    _createClass(Breadcrumb, [{
      ...
      key: "immediatePush",
      value: function immediatePush(data) {
        ...
        this.stack.push(data); // make sure xhr fetch is behind button click
    ...
    _createClass(BaseMonitor, [{
      ...
      value: function handleRecordError() {
        try {
          ...
          console.log("------------------------ ".concat(this.category, " ------------------------\n"), errorInfo); // 记录日志
  ...
  var AxiosError = /*#__PURE__*/function (_BaseMonitor) {
    ...
    _createClass(AxiosError, [{
      ...
      value: function handleError(error) {
        ...
        if (error !== null && error !== void 0 && (_error$config = error.config) !== null && _error$config !== void 0 && _error$config.url) {
